                    ...
                    <form action="{{ route('doctor-schedules.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control selectric @error('doctor_id') @enderror"
                                     name="doctor_id">
                            ...
                            {{-- <div class="form group">
                                ...
                                <div class="fform-check form-check-inline">
                                    <input class="form-check @error('status') is-invalid @enderror"       
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="role" value="active" class="selectgroup-input"
                                            checked="">
                                        <span class="selectgroup-button">Active</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="role" value="inactive" class="selectgroup-input">
